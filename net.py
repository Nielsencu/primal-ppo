...
class SCRIMPNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.cost_value_layer = nn.Linear(NetParameters.NET_SIZE, 1)
    ...
    def forward(self, obs, vector, input_state):
        ...
        cost_value = self.cost_value_layer(x)
        blocking = F.sigmoid(self.blocking_layer(x))
        return policy, value, blocking, policy_sig, x, policy_layer, cost_value
